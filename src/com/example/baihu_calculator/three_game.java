...
public class three_game extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.three_game);//R.layout.activity_main        
	...
	public void calc(View v)
    {
	    ...
	    //计算拖鸟	
     	for(int i=0;i<bh[0].length-1;i++)
     	{
     		double s=0;
     		for(int j=0;j<bh[0].length-1;j++)
     	     	{
     				if(bh[0][i]>bh[0][j])
     				{
     					s=bh[2][i] + bh[2][j];
